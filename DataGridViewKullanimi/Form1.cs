...
namespace DataGridViewKullanimi
{
    public partial class Form1 : Form
    {
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            //o anki seçmiş olduğumuz satırın değerlerini label'lara yazdırdık..
        }
        ...
        {
            dataGridView1.Rows.Add(1, "Alihandro", "Dimitriadis");
            dataGridView1.Rows.Add(2, "Mahmut", "Dimitriadis");
            dataGridView1.Rows.Add(3, "Dimitri", "Dimitriadis");
        }
    }
}
